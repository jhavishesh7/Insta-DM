    ...
    <div className="hidden lg:flex flex-col w-[380px] sticky top-20 h-fit bg-[#0c0d18] rounded-2xl p-6 border border-white/[0.06] gap-y-6 shadow-2xl">
      <div className="flex flex-col gap-y-2">
        <div className="flex items-center justify-between">
          {edit ? (
            ...
            <h3 className="text-xl font-bold truncate pr-4 text-gradient">ZeroPilot</h3>
          )}
          {!edit && (
            <Button
              onClick={enableEdit}
          ...
          <div className="">
            {listener ? (
              <div className="flex flex-col gap-y-2">
                ...
                <p className="text-[9px] text-orange-400/70 font-bold uppercase tracking-widest">
      ...
      <div className="mt-auto pt-4 border-t border-white/5 flex flex-col gap-y-4">
        {listener?.listener === "SMARTAI" && (
          <AIBusinessForm 
            onSuccess={(prompt) => {
              saveListener(id, "SMARTAI", prompt);
