...
-- CreateTable
CREATE TABLE "PersonalAssistant" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "userId" UUID NOT NULL,
    "prompt" TEXT NOT NULL DEFAULT 'You are a helpful e-commerce assistant. Analyze user sentiment and respond professionally.',
    "active" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "PersonalAssistant_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "PersonalAssistant_userId_key" ON "PersonalAssistant"("userId");
...
-- AddForeignKey
ALTER TABLE "PersonalAssistant" ADD CONSTRAINT "PersonalAssistant_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
